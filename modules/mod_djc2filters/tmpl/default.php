<?php
/**
 * @version $Id: default.php 112 2013-01-29 14:44:40Z michal $
 * @package DJ-Catalog2
...
if (isset($active->query['option'])) {
    if ($active->query['option'] == 'com_djcatalog2' && JRequest::getVar('option') == 'com_djcatalog2') {
        if (isset($active->query['view'])) {
            if ($active->query['view'] == 'items' && JRequest::getVar('view') == 'items') {
                $catalogView = true;
