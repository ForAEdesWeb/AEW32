...
<div id="k2Container" class="itemBlog itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="itemHeader">
	  ...
	  <?php endif; ?>
		...
		<div class="itemCategory">
			<span><?php echo JText::_('JAK2_PUBLISHED_IN'); ?></span>
